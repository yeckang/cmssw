...
# with command line options: step4 -s HARVESTING:@standardValidation+@standardDQM+@ExtraHLT+@miniAODValidation+@miniAODDQM+@nanoAODDQM --conditions auto:phase1_2021_design --mc --geometry DB:Extended --scenario pp --filetype DQM --era Run3 -n 100 --filein file:step3_inDQM.root --fileout file:step4.root
