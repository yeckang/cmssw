...
# with command line options: TenMuExtendedE_0_200_pythia8_cfi -s GEN,SIM -n 10 --conditions auto:phase1_2021_design --beamspot GaussSigmaZ4cm --datatier GEN-SIM --eventcontent FEVTDEBUG --geometry DB:Extended --era Run3 --relval 10000,100 --fileout file:step1.root
