...
# with command line options: step3 -s RAW2DIGI --conditions auto:phase1_2021_design --datatier GEN-SIM-DIGI-RECO -n 10 --eventcontent RECOSIM --geometry DB:Extended --era Run3 --filein file:step2.root --fileout file:step3.root
...
process.load('EventFilter.GEMRawToDigi.GEMUnpackTester_cfi')
...
process.raw2digi_step = cms.Path(process.RawToDigi*process.GEMUnpackTester)
