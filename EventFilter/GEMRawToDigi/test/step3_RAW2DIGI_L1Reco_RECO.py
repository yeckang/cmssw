...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:/eos/cms/tier0/store/data/Commissioning2022/Cosmics/RAW/v1/000/350/174/00000/6e0d15ec-e406-46f0-826f-7627c0d262c7.root'),
...
process.GlobalTag = GlobalTag(process.GlobalTag, '123X_dataRun3_Express_v5', '')
# Call eMap for GEM
process.GlobalTag.toGet = cms.VPSet(cms.PSet(record=cms.string("GEMChMapRcd"),
                                             tag=cms.string("GEMChMapRcd"),
                                             connect=cms.string("sqlite_fip:EventFilter/GEMRawToDigi/data/GEMChMap_Run3_2022.db")),
)
